...
SerialSettingDialog* SerialSettingDialog::instance()
{
    static SerialSettingDialog* _instance = 0;
    if(_instance == 0)
    {
        _instance = new SerialSettingDialog();
    }
    return _instance;
}
...
void SerialSettingDialog::fillPortsParameters()
{
    ...
    ui->BaudRate_Box->addItem(QStringLiteral("57600"), QSerialPort::Baud57600);
...
void SerialSettingDialog::SendData(const char *data, qint64 len)
{
...
QSerialPort* SerialSettingDialog::getSerial()
{
    return serial;
}
